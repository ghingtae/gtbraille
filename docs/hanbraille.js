...
var _HanBraille_instances, _HanBraille_hanMappingAntiCollision, _HanBraille_hanMappingContract, _HanBraille_hanMapping;
...
_HanBraille_hanMappingAntiCollision = new WeakMap(), _HanBraille_instances = new WeakSet(), _HanBraille_hanMappingContract = function _HanBraille_hanMappingContract() {
    return [
        /* Special cases */
        ...
        { symbol: '성'.normalize('NFD'), braille: HanBraille.BraiToUCS([6], [1, 2, 4, 5, 6]), condition: !this.u11bc_null },
        { symbol: '썽'.normalize('NFD'), braille: HanBraille.BraiToUCS([6], [6], [1, 2, 4, 5, 6]), condition: !this.u11bc_null },
        { symbol: '정'.normalize('NFD'), braille: HanBraille.BraiToUCS([4, 6], [1, 2, 4, 5, 6]), condition: !this.u11bc_null },
        { symbol: '쩡'.normalize('NFD'), braille: HanBraille.BraiToUCS([6], [4, 6], [1, 2, 4, 5, 6]), condition: !this.u11bc_null },
        { symbol: '청'.normalize('NFD'), braille: HanBraille.BraiToUCS([5, 6], [1, 2, 4, 5, 6]), condition: !this.u11bc_null },
        { symbol: '셩'.normalize('NFD'), braille: HanBraille.BraiToUCS([6], [1, 5, 6], [2, 3, 5, 6]), condition: !this.u11bc_null },
        { symbol: '쎵'.normalize('NFD'), braille: HanBraille.BraiToUCS([6], [6], [1, 5, 6], [2, 3, 5, 6]), condition: !this.u11bc_null },
        { symbol: '졍'.normalize('NFD'), braille: HanBraille.BraiToUCS([4, 6], [1, 5, 6], [2, 3, 5, 6]), condition: !this.u11bc_null },
        { symbol: '쪙'.normalize('NFD'), braille: HanBraille.BraiToUCS([6], [4, 6], [1, 5, 6], [2, 3, 5, 6]), condition: !this.u11bc_null },
        { symbol: '쳥'.normalize('NFD'), braille: HanBraille.BraiToUCS([5, 6], [1, 5, 6], [2, 3, 5, 6]), condition: !this.u11bc_null },
        ////12~15항
        ...
        { symbol: '\u1167\u11bc', braille: HanBraille.DotsToUni(1, 2, 4, 5, 6), condition: !this.u11bc_null },
        ...
        { symbol: '\u1169\u11bc', braille: HanBraille.DotsToUni(1, 2, 3, 4, 5, 6), condition: !this.u11bc_null },
